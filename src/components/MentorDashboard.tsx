...
import { mockFeedbackRequests, mockMentor, FeedbackRequest } from '../types';
...
export function MentorDashboard() {
  ...
  const pendingRequests = feedbackRequests.filter((r): r is FeedbackRequest => {
    return r.status === 'pending' && typeof r.id === 'number';
  });
  const completedRequests = feedbackRequests.filter((r): r is FeedbackRequest => {
    return r.status === 'completed' && typeof r.id === 'number';
  });
        ...
        <div className="space-y-4">
          ...
          <div className="mt-6">
            ...
            <div className="flex justify-end space-x-4 mt-4">
              ...
              <button
                onClick={() => handleSubmitFeedback(request.id!, feedback)}
